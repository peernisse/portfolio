...
<h1 style="padding-top:10px;">Select Projects</h1>

<hr/>

## Internal Roles and Development

**Utah Department of Health and Human Services COVID-19 Response, 2021 - Present**

Manged instance of DOMO BI software for internal COVID-19 response dashboards. Developed R Shiny internal dashboards for the Population Health office COVID-19 response and population health dashboard system.

**Utah Department of Health and Human Services Medical Examiner Application Development, 2021 - Present**

Developed project charter, business case document, scope of work and RFP for medical examiner office case management software procurement. Managed this project in accordance with SAFe project management framework and principles. 

**Stantec Environmental Services Technical Lead in Data Analysis and Statistics for the USA, 2016-2021**
...
**Application Development, Numerous Projects, 2010-2021**

Completed and/or collaborated on custom project applications for data managment, data clean up, data query tools, analysis and visualization tools using combinations of MS Access, MS Excel, SharePoint Designer, R Markdown and R Shiny.

<hr/>

## Active Mining/Baseline Characterization

**Data Analyst, Mine Expansion Baseline Characterization, Confidential Client, Manitoba, CA, 2018-2021**
...
**Data Analyst, APP Quarterly Groundwater Monitoring, Confidential Client, Arizona, 2012-2019**
...
**Task Manager/Scientist, Baseline Surface Water Characterization, Confidential Client, Fairbanks, Alaska, 2012-2016**
...
**Data Manager/Statistical Analyst, Abandoned Uranium Mines, Confidential Client, New Mexico, 2015-2017**
...
**Data Analyst, CERCLA Groundwater Long Term Monitoring, Confidential Client, Utah, 2015-2021**
...
**Data Analyst, RCRA Groundwater Statistical Analyses, Confidential Client, Tennessee, 2019-2021**
...
**Project Manager - Utah Army National Guard, Environmental Resources Management (ERM), 2008-2021**
...
**Project Manager/Scientist, Operable Unit 4 Groundwater Remediation, Hill Air Force Base, Utah, 2009-2012**
